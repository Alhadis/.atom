...
/**
 * Generate a command to dispatch other commands based on editor's grammar.
 *
 * @param {Object} input
 * @return {Function}
 */
...
global.evalCSS = evalCSS;
global.getGrammarAtCursor = getGrammarAtCursor;
global.ContextualCommand = ContextualCommand;
global.inced = _=> require(ed.buffer.file.path);
