...
const {inced, loadFromCore, loadGrammar, coreLibs} = require("./loaders.js");
const {filesafe, formatJSON} = require("../commands/editor.js");
const {getToken, getTokens, toPoint, toRange} = require("./buffer.js");
const {at, bc, mtime, getProperties} = require("./other.js");
...
Object.assign(global, {
	CompositeDisposable, Disposable, formatJSON, getToken, getTokens,
	at, bc, mtime, inced, loadFromCore, loadGrammar, filesafe,
	Atom:     require("atom"),
	body:     document.body,
	...
	rgb: (r, g, b, a = null) => "#" + [r, g, b, a]
		.filter(n => null !== n)
		.map((n, i) => {
			if(3 === i) n = Math.round(255 * n);
			return (n < 16 ? "0" : "") + n.toString(16);
		}).join(""),

	rgba: (...args) => global.rgb(...args),
