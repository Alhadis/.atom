...
module.exports = {
	...
	/**
	 * Display an error message to the user, then raise an exception.
	 *
	 * @param {String} [reason="Command aborted"]
	 * @param {Object} [notifyOptions=null]
	 * @throws {Error}
	 * @internal
	 */
	error(reason = "Command aborted", notifyOptions = null){
		atom.notifications.addError(reason, {dismissable: true, ...notifyOptions});
