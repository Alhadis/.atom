...
// Support CommonJS modules and increase JavaScript's token limit
loadGrammar("source.js").then(js => {
	js.fileTypes.push("cjs");
	js.maxTokensPerLine = 500;
});


// Define custom filetypes without upsetting File Icons
loadGrammar("source.json").then(json =>
	json.fileTypes.push("css.map", "js.map", "mjs.map", "nycrc"));
